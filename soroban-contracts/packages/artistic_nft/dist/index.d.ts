...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDKENMCEULWNP444N24VUU74IITFA6VSNTKBD6UMDD3MA3YN4JT4YUEO";
    };
};
...
export interface Client {
     ...
     */
    create_event: ({ organizer, art_metadata_url }: {
        organizer: string;
        art_metadata_url: string;
    }, options?: {
        /**
     ...
     */
    enable_minting: ({ event_id, organizer }: {
        event_id: u64;
        organizer: string;
    }, options?: {
        /**
     ...
     */
    batch_mint: ({ event_id, participants, organizer }: {
        event_id: u64;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        create_event: (json: string) => AssembledTransaction<bigint>;
        enable_minting: (json: string) => AssembledTransaction<null>;
        batch_mint: (json: string) => AssembledTransaction<bigint[]>;
        get_nft: (json: string) => AssembledTransaction<ArtisticNFT>;
        transfer_nft: (json: string) => AssembledTransaction<null>;
