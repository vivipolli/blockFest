...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBM4UPJOXAWI5PZEXSQHJFHVJO63LNE3IB44VDKU5J7JPQ57HPTFM2JN";
    };
};
export type DataKey = {
    tag: "Owner";
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        token_image: (json: string) => AssembledTransaction<string>;
