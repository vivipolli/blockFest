...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CB5ZAZ3DGWAUQVVZOOJM6EE6UQLRZLTL42A7ZIAKYSDDS6KF6GWXPM67";
    };
};
...
export interface Client {
     ...
     */
    mint_ticket: ({ to, event_metadata_url, organizer, price, token_id }: {
        to: string;
        event_metadata_url: string;
        organizer: string;
        price: i128;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        mint_ticket: (json: string) => AssembledTransaction<bigint>;
        get_ticket: (json: string) => AssembledTransaction<Ticket>;
        transfer_ticket: (json: string) => AssembledTransaction<null>;
        use_ticket: (json: string) => AssembledTransaction<null>;
        is_ticket_used: (json: string) => AssembledTransaction<boolean>;
    };
}
